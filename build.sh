#!/bin/bash
# FastEnhancer + HPF + AGC + Dereverb — WASM SIMD build script
#
# Usage: bash build.sh
#
...
echo "=== FastEnhancer Pipeline WASM SIMD Build ==="
...
C_FILES="$SRC_DIR/main.c \
         $SRC_DIR/denoise/fastenhancer.c \
         $SRC_DIR/denoise/simd.c \
         $SRC_DIR/denoise/fft.c \
         $SRC_DIR/denoise/stft.c \
         $SRC_DIR/denoise/conv.c \
         $SRC_DIR/denoise/gru.c \
         $SRC_DIR/denoise/attention.c \
         $SRC_DIR/denoise/activations.c"

# Dereverb files
C_FILES="$C_FILES \
         $SRC_DIR/dereverb/dereverb.c \
         $SRC_DIR/dereverb/lstm.c \
         $SRC_DIR/dereverb/wpe.c \
         $SRC_DIR/dereverb/wiener.c"

EXPORTED_FUNCTIONS="_fe_init,_fe_run,_fe_free,\
_fe_set_hpf,_fe_set_input_agc,_fe_set_output_agc,_fe_set_dereverb,\
_fe_agc_init,_fe_set_input_agc_compression,_fe_set_output_agc_compression,\
_malloc,_free"
...
class FEProcessor {
    constructor(wasm, weightBytes, derevWeightBytes) {
        ...
        wasm._fe_set_hpf(1);
        wasm._fe_agc_init();
        wasm._fe_set_input_agc(1);
        wasm._fe_set_output_agc(1);
        wasm._fe_set_input_agc_compression(12);
        wasm._fe_set_output_agc_compression(18);
